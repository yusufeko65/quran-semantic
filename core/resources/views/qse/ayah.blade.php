...
@section('content')
    ...
    {{-- Fase 1 (HANDOFF-CODE-redesign-fase2): struktur visual dirombak
         mendekati mockup (kolom sempit, kata terpusat tanpa kotak besar
         "mushaf") — TAPI terjemahan ayat + terjemahan per-kata (wordgloss)
         DIPERTAHANKAN penuh, ini kekayaan nyata di luar yang ditunjukkan
         mockup, bukan sesuatu yang boleh hilang demi kecocokan visual. --}}
    <div class="ayah-focus">
        <a href="{{ route('qse.page.surah', $ayah->surah_id) }}" class="ayah-focus-back">
            &larr; {{ $ayah->surah->transliteration }}
        </a>

        <div class="ayah-focus-caption">
            QS {{ $ayah->ref }} — klik kata mana pun untuk memuat Lapisan 1–4 di bawah
        </div>

        @if ($ayah->currentClassification)
            <div class="ayah-focus-classification">
        ...
        <div class="ayah-focus-words mushaf-text tajwid-on" id="mushaf-text" dir="rtl">
        ...
        {{-- ————— TERJEMAHAN PER KATA — dipertahankan, chip ringan ————— --}}
        <div class="ayah-focus-gloss">
            <div class="surah-ayah-tr-label">Terjemahan per kata</div>
